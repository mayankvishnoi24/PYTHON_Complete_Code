# print("Hii") #print() is a function. print is used for the output print on the display..
...
print("Multiply Result 5 * 5 = ", 5 * 5)
print("Division Result 5 / 5 = ", 5 / 5)
print("modulus result 11 % 5=", 11 % 5)
print("comparison of 5 with 10", )
